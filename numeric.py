...
def build(add, part, rng):
    ...
    plan = [
        (inferop, "อนุมานตัวดำเนินการ", 2, [0, 3]),
        (inferop, "อนุมานตัวดำเนินการ", 3, [1]),
        (pairsum, "ตอบเป็นคู่", 2, [4, 2]),
        (pairsum, "ตอบเป็นคู่", 3, [0]),
        (codeword, "เงื่อนไขรหัส", 3, [1, 3]),
        (nested, "พีชคณิตแปลก", 3, [2]),
        (tower, "พีชคณิตแปลก", 3, [4]),
    ]
    n = 0
