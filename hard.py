...
def build(add, addnum, P1, P2):
    ...
    # ============================== พาร์ทที่ 1 (15) ==============================
    addnum(P1, "ลำดับ", "2, 3, 10, 15, 26, ?", 35, 4, lvl=2)
    addnum(P1, "ลำดับ", "1, 3, 12, 60, 360, ?", 2520, 300, lvl=1)
    addnum(P1, "ลำดับ",
           "ลำดับเลขคณิตลำดับหนึ่งมีพจน์ที่ 5 เท่ากับ 23 และผลบวก 10 พจน์แรกเท่ากับ 255 พจน์แรกของลำดับนี้มีค่าเท่าใด", 3, 1, lvl=2)
    add(P1, "ปริศนาตัวอักษร",
        "ถ้า MOUSE เขียนเป็นรหัสว่า NPVTF แล้ว KEYBOARD จะเขียนเป็นรหัสว่าอย่างไร",
        ["JDXAMZQC", "LFZCPBSE", "LFZBPBSE", "LEZCPBSE", "KFZCPBSE"], 1, lvl=1)
    add(P1, "เมทริกซ์ตัวเลข", "จากตาราง ตัวเลขในช่อง ? คือข้อใด (ทุกแถวใช้กฎเดียวกัน)",
        ["30", "32", "35", "36", "40"], 3, lvl=2,
        img=D.numgrid([[3, 5, 16], [4, 6, 25], [5, 7, "?"]], "hmx1"))
    addnum(P1, "โจทย์ปัญหาคณิต",
           "จำนวนเต็มบวกสามหลักที่หารด้วย 7 ลงตัว และมีเลขโดดหลักหน่วยเป็น 0 มีทั้งหมดกี่จำนวน", 13, 2, lvl=1)
    ...
    add(P1, "มุมเข็มนาฬิกา",
        ...
        ["20 นาที", "21 3/11 นาที", "21 9/11 นาที", "22 2/11 นาที", "23 1/11 นาที"], 2, lvl=2)
    ...
    addnum(P1, "หน่วยและการประมาณค่า",
           "ปั๊มน้ำสูบน้ำได้ 15 ลิตรต่อนาที ต้องใช้เวลากี่ชั่วโมงจึงจะสูบน้ำเต็มถังขนาด 5.4 ลูกบาศก์เมตร", 6, 1, lvl=1)
    # ตัวเลือกเป็นกำลังของ 2 ทั้งห้า ด้วยเหตุผลเดียวกับข้อพับกระดาษ
    add(P1, "unseen",
        "แบคทีเรียชนิดหนึ่งแบ่งตัวเพิ่มเป็นสองเท่าทุก 20 นาที ถ้าเริ่มจาก 1 ตัว เมื่อเวลาผ่านไป 4 ชั่วโมงจะมีแบคทีเรียกี่ตัว",
        ["1024", "2048", "4096", "8192", "16384"], 2, lvl=1)
