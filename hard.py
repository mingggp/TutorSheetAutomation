...
def build(add, addnum, P1, P2):
    ...
    addnum(P1, "โจทย์ปัญหาคณิต",
           "ก และ ข ช่วยกันทำงานชิ้นหนึ่งเสร็จใน 4 วัน แต่ถ้า ก ทำคนเดียว 3 วันแล้วให้ ข ทำต่ออีก 8 วันจึงเสร็จ ถ้า ข ทำคนเดียวจะเสร็จในกี่วัน",
           20, 4)
    add(P1, "โจทย์ปัญหาคณิต",
        "ราคาสินค้าชิ้นหนึ่งถูกปรับขึ้น 25% แล้วต่อมาถูกลดลง 20% จากราคาใหม่ ราคาสุดท้ายเปลี่ยนแปลงจากราคาเดิมอย่างไร",
        ["ลดลง 5%", "ลดลง 2.5%", "เท่าราคาเดิม", "เพิ่มขึ้น 2.5%", "เพิ่มขึ้น 5%"], 2)
    ...
    add(P1, "ความน่าจะเป็น",
        "ในกล่องมีลูกบอลสีแดง 5 ลูก สีน้ำเงิน 3 ลูก สุ่มหยิบทีละลูกโดยไม่ใส่คืนจำนวน 2 ลูก ความน่าจะเป็นที่ได้ลูกบอลต่างสีกันเป็นเท่าใด",
        ["9/28", "15/56", "5/14", "15/28", "3/4"], 3)
    addnum(P1, "เชาวน์ปัญญา",
           ...
           240, 30)
    addnum(P1, "โจทย์ปัญหาคณิต",
           "ผสมสารละลายเข้มข้น 30% ปริมาตร 200 มิลลิลิตร เข้ากับสารละลายเข้มข้น 60% ปริมาตร 100 มิลลิลิตร สารละลายผสมมีความเข้มข้นกี่เปอร์เซ็นต์",
           40, 4)
